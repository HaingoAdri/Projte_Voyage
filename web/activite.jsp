    ...
    <div class="container">
      ...
      <div class="card">
        <div class="card_header">
            <h1>Insertion de activite :</h1>
        </div>
        <p></p>
        <div class="card_body">
            <div class="row marketing">
                <form action="Insert_Activte" method="post">
                    <div class="row">
                    ...
                    <p></p>
                    <div class="input-group ">
                        <span class="input-group-addon" id="sizing-addon2">Prix :</span>
                        <input type="number" class="form-control" placeholder="prix" aria-describedby="sizing-addon2" name="prix">
                    </div>
                    <p></p>
